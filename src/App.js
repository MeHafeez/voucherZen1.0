...
import logoImage from '../src/white_logo.png';
  ...
  return (
    ...
    <section className="preview">
      ...
      <div className="voucher-list">
        <div
          className="voucher-item movie"
          onClick={() => handleVoucherTypeClick("Movie")}
        >
          Movie
        </div>
        <div
          className="voucher-item food"
          onClick={() => handleVoucherTypeClick("Food")}
        >
          Food
        </div>
        <div
          className="voucher-item shopping"
          onClick={() => handleVoucherTypeClick("Shopping")}
        >
          Shopping
        </div>
        <div
          className="voucher-item travel"
          onClick={() => handleVoucherTypeClick("Travel")}
        >
          Travel
        </div>
        <div
          className="voucher-item electronics"
          onClick={() => handleVoucherTypeClick("Electronics")}
        >
          Electronics & Other
        </div>
      </div>
    ...
    <footer className="footer">
        <p>© 2024 VoucherZen is Proudly Powered By doTech.</p>
